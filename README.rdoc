...
Here's a jQuery plugin that rotates through list items with a nice fade effect. You may nest any type of element you like inside a given list item. Here's a {live demo}[http://coryschires.com/jquery-quote-rotator-plugin/].
